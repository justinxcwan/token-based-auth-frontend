        ...
        this.$get = function($http, OAuthToken) {
            var OAuth = function() {
                ...
                _prototypeProperties(OAuth, null, {
                    ...
                    getAccessToken: {
                        value: function getAccessToken(user, options, success, error) {
                            ...
                            // Encode the String
                            var encodedString = btoa(config.clientId + ":" + config.clientSecret);
                ...
                _prototypeProperties(OAuthToken, null, {
                    setToken: {
                        value: function setToken(data) {
                            return $cookieStore.put(config.name, data, config.options);
                        },
                        writable: true,
                        enumerable: true,
                        configurable: true
                    ...
                    getToken: {
                        value: function getToken() {
                            return $cookieStore.get(config.name);
                        },
                        writable: true,
                        enumerable: true,
                        configurable: true
                    ...
                    removeToken: {
                        value: function removeToken() {
                            return $cookieStore.remove(config.name);
                        },
                        writable: true,
                        enumerable: true,
                        configurable: true
